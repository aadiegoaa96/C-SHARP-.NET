...
{
    public partial class prueba33 : Form
    {
        ...
        private void Timer1_Tick(object sender, EventArgs e)    // CONCLUSIÓN 1_ EL MÉTODO CORRE A UN RELOJ PERO EN CIERTO TIEMPO__ (EXISTEN 2 PARÁMETROS) _ SE DICE QUE OCURRE UNA INTERRUPCIÓN
        {
        ...
        private void Venteo_DeAlta()
        {
            ...
            ws11.Cells[111, 1] = "Tipo de válvula: Válvula de Venteo de Alta";   //realtime , realtime2
        ...
        private void Reecirculacion()
        {
            ...
            ws9.Cells[109, 1] = "Presión max. : " + maxi2;
            ws10.Cells[110, 1] = "Presión min. : " + mini2;
            ws11.Cells[111, 1] = "Tipo de válvula: Válvula de Reecirculación";   //realtime , realtime2
            ws12.Cells[112, 1] = "Observaciones: _____________________________________________________________________";   //realtime , realtime2
            ws13.Cells[113, 1] = "____________________________________________________________________________________";   //realtime , realtime2
            ws14.Cells[114, 1] = "____________________________________________________________________________________";   //realtime , realtime2
            ws15.Cells[118, 1] = "Elaboró: ______________________________________________________";   //realtime , realtime2
        ...
        private void Pegging()
        {
            ...
            ws9.Cells[109, 1] = "Presión max. : " + maxi2;
            ws10.Cells[110, 1] = "Presión min. : " + mini2;
            ws11.Cells[111, 1] = "Tipo de válvula: Válvula Pegging";   //realtime , realtime2
            ws12.Cells[112, 1] = "Observaciones: _____________________________________________________________________";   //realtime , realtime2
            ws13.Cells[113, 1] = "____________________________________________________________________________________";   //realtime , realtime2
            ws14.Cells[114, 1] = "____________________________________________________________________________________";   //realtime , realtime2
            ws15.Cells[118, 1] = "Elaboró: ______________________________________________________";   //realtime , realtime2
        ...
        // Function to save ListView to Excel
        private void Alimentacion_Deagua()
        {
            Microsoft.Office.Interop.Excel.Application xla = new Microsoft.Office.Interop.Excel.Application();
            xla.Visible = true;
            Microsoft.Office.Interop.Excel.Workbook wb = xla.Workbooks.Add(Microsoft.Office.Interop.Excel.XlSheetType.xlWorksheet);
            ...
            ws9.Cells[109, 1] = "Presión max. : " + maxi2;
            ws10.Cells[110, 1] = "Presión min. : " + mini2;
            ws11.Cells[111, 1] = "Tipo de válvula: Válvula de Alimentación de Agua";   //realtime , realtime2
            ws12.Cells[112, 1] = "Observaciones: _____________________________________________________________________";   //realtime , realtime2
            ws13.Cells[113, 1] = "____________________________________________________________________________________";   //realtime , realtime2
            ws14.Cells[114, 1] = "____________________________________________________________________________________";   //realtime , realtime2
            ws15.Cells[118, 1] = "Elaboró: ______________________________________________________";   //realtime , realtime2
        ...
        private void Flujo_Minimo()
        {
            ...
            ws9.Cells[109, 1] = "Presión max. : " + maxi2;
            ws10.Cells[110, 1] = "Presión min. : " + mini2;
            ws11.Cells[111, 1] = "Tipo de válvula: Válvula de Flujo Mínimo";   //realtime , realtime2
            ws12.Cells[112, 1] = "Observaciones: _____________________________________________________________________";   //realtime , realtime2
            ws13.Cells[113, 1] = "____________________________________________________________________________________";   //realtime , realtime2
            ws14.Cells[114, 1] = "____________________________________________________________________________________";   //realtime , realtime2
            ws15.Cells[118, 1] = "Elaboró: ______________________________________________________";   //realtime , realtime2
        ...
        private void SaveToExcel2() ///MUESTREO 40 MINUTOS
        {
            Microsoft.Office.Interop.Excel.Application xla = new Microsoft.Office.Interop.Excel.Application();
            xla.Visible = true;
            Microsoft.Office.Interop.Excel.Workbook wb = xla.Workbooks.Add(Microsoft.Office.Interop.Excel.XlSheetType.xlWorksheet);
        ...
        private void BtConnect_Click(object sender, EventArgs e)
        {
            ...
            if (!serialPort1.IsOpen)
            {
                ...
                try
                {
                    ...
                    Timer2.Start();
                    Graficar();
                    serialPort1.Write("2"); // Send "1" para realizar mediciones de temperatura y presión
                    bt_Save.Enabled = false;
                    bt_SalvarFoto.Enabled = false;
                    groupBox5.Visible = true;
                    bt_Cargar.Enabled = false;
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Venteo_DeAlta(); // Execute the function to save ListView to Excel 
            ...
            {
                Reecirculacion(); // Execute the function to save ListView to Excel 
                SaveToExcel2(); // Execute the function to save ListView to Excel 
            ...
            {
                Pegging(); // Execute the function to save ListView to Excel 
                SaveToExcel2(); // Execute the function to save ListView to Excel 
            ...
            else if(traloi == DialogResult.OK && valv == 4)
            {
                Alimentacion_Deagua(); // Execute the function to save ListView to Excel 
                SaveToExcel2(); // Execute the function to save ListView to Excel 
            ...
            else if(traloi == DialogResult.OK && valv == 5)
            {
                Flujo_Minimo(); // Execute the function to save ListView to Excel 
                SaveToExcel2(); // Execute the function to save ListView to Excel 
        ...
        private void Prueba33_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void RadioButton7_CheckedChanged(object sender, EventArgs e)           // venteo de alta
        {
        ...
        private void RadioButton8_CheckedChanged(object sender, EventArgs e)           // reecirculación
        {
            bt_Connect.Enabled = true;
            bt_Save.Enabled = false;
            bt_SalvarFoto.Enabled = false;
        ...
        private void RadioButton10_CheckedChanged(object sender, EventArgs e)           //  Alimentacion_Deagua
        {
            bt_Connect.Enabled = true;
            bt_Save.Enabled = false;
            bt_SalvarFoto.Enabled = false;
        ...
        private void RadioButton11_CheckedChanged(object sender, EventArgs e)           //venteo de alta
        {
            bt_Connect.Enabled = true;
            bt_Save.Enabled = false;
            bt_SalvarFoto.Enabled = false;
